...
[QuantumESPRESSORecipes](https://github.com/MineralsCloud/QuantumESPRESSORecipes.jl).
...
## Install QuantumESPRESSORecipes
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("QuantumESPRESSORecipes")
   ```

3. Run

   ```julia-repl
   julia> using QuantumESPRESSORecipes
   ```
...
version of QuantumESPRESSORecipes, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuantumESPRESSORecipes.jl"
```

in the second step above.

## Update QuantumESPRESSORecipes
...
our [GitHub repository](https://github.com/MineralsCloud/QuantumESPRESSORecipes.jl)
for new releases.
Once we release a new version, you can update QuantumESPRESSORecipes by typing

```@repl
using Pkg
Pkg.update("QuantumESPRESSORecipes")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall QuantumESPRESSORecipes
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("QuantumESPRESSORecipes")

   julia> Pkg.gc()
   ```

2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall QuantumESPRESSORecipes.
